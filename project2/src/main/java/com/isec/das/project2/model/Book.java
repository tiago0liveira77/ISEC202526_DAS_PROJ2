...
public class Book { // Class definition for the Book entity
    ...
    @Lob // Marks this field as a Large Object (BLOB/CLOB) in the database, suitable for
         // large text
    @com.fasterxml.jackson.annotation.JsonIgnore // Hides this field from default JSON serialization (Singleton
